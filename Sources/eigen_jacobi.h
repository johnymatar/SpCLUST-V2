...
int main ( )
{
	double *a, *d, *v; //a holds the matrix, d holds the eigenvalues, v holds the eigenvectors
	int n=4;
	...
	if (!(d = new double[n])){
		cout << "Allocation for 'd' failed. \n";
		delete []a;
		return 0;
	} //End if
	//Allocate space for pointers to rows of v matrix
	if (!(v = new double[n*n])){
		cout << "Allocation for 'v' failed. \n";
		delete []a;
		delete []d;
		return 0;
	} //End if

	a[0]=4.0; a[1]=-30.0; a[2]=60.0; a[3]=-35.0; a[4]=-30.0; a[5]=300.0; a[6]=-675.0; a[7]=420.0; 
    a[8]=60.0; a[9]=-675.0; a[10]=1620.0; a[11]=-1050.0; a[12]=-35.0; a[13]=420.0; a[14]=-1050.0; a[15]=700.0;
